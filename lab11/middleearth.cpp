...
string all_city_names[] = {
    ...
    // END marker
    "END"
};	/**< A string array of all the possible cities that can be in the world */

// Iluvatar, the creator of Middle-Earth
/** @brief The constructor that randomly generates the world and city locations.
 *
 * @param xsize The width of the world, usually 20.
 * @param ysize The height of the world, also usually 20.
 * @param num_cities The number of cities in the world, max of 40
 * @param seed An integer corresponding to a certain arrangement of the cities, using -1 will generate a random city
 */
...
/** @brief Deletes the dynamically allocated variables, which is just the array of distances.
 */
...
/** @brief prints out statistics of the world
 *
 * This method prints out the number of cities in the world, and their x and y positions within the world.
 * @return void
 */
...
/** @brief Prints out a table of the distances between all cities.
 * @return void
 */
...
/** @brief Returns the distance between 2 cities.
 *
 * @return The distance between the 2 cities as a float.
 * @param city1 The first city.
 * @param city2 The second city a distance away from city1.
...
/** @brief Returns a vector of the cities that must be visited.
 *
 * @return The vector of cities that need to be visited, the first element is the start and end city.
 * @param length The number of cities that are to be visited, cannot be greater than the number of cities in the world.
 */
